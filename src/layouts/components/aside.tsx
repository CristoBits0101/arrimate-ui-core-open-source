...
export default function Aside() {
  ...
  return (
    <aside
      className={`dark:bg-[#26272C] hidden md:flex col-span-1 flex-col gap-8 min-h-screen max-h-fit h-auto p-8 sticky top-0 overflow-y-auto max-w-80 ${styles.noScrollbar}`}
    >
      <Sidebar />
      {component}
    </aside>
