...
export default function AuthButtons() {
  ...
  return (
    <div className='flex w-full h-[2.5rem] flex-row items-center justify-between'>
      <button className='shadow shadow-[#edeced] font-medium w-[7.25rem] flex flex-row justify-center gap-1 bg-[#F4F4F4] p-2 border-[0.05rem] border-[#bfbdc050] border-solid hover:bg-[#bfbdc050] h-full'>
