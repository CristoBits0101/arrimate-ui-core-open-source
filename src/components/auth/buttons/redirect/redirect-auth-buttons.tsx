...
export default function AuthButtons() {
  ...
  return (
    <div className='flex w-full h-[2.5rem] flex-row items-center justify-between'>
      <button className='font-medium w-[7.25rem] flex flex-row justify-center gap-1 bg-[#F4F4F4] pr-4 pl-4 pt-2 pb-2 border-[0.05rem] border-[#bfbdc050] border-solid hover:bg-[#bfbdc050] h-full'>
