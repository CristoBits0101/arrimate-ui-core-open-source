...
import unknownImage from '@/modules/marketing/assets/unknownImage.jpg'
...
export default function ArrimateFollowCard({
  ...
  return (
    <article className='relative border-solid border-[0.05rem] border-[#EBEAEB] rounded-xl w-full h-fit flex flex-col gap-1 p-4 justify-center items-center'>
      {countryCode && (
