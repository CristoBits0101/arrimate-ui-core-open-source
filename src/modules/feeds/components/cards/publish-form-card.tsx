...
import EventForm from '@/modules/feeds/create-post/components/forms/event-form'
...
import StoryForm from '@/modules/feeds/create-post/components/forms/story-form'
